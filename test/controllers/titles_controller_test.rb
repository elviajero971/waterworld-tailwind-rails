...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { category_id: @title.category_id, description: @title.description } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { category_id: @title.category_id, description: @title.description } }
